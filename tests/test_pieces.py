...
from app.models.pieces import Rook, Bishop, Lance, Silver_General, Knight
...
class Silver_GeneralTestCase(unittest.TestCase, PiecesTest):
    board = Board()
    def setUp(self):
...
class KnightTestCase(unittest.TestCase, PiecesTest):
    board = Board()
    def setUp(self):
